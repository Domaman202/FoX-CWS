...
public class FoxMixinLogger extends LoggerAdapterAbstract {
    ...
    public static @NotNull ILogger get(final @NotNull String name) {
        return LOGGERS.computeIfAbsent(name, FoxMixinLogger::new);
    }

    private final TaggedLogger logger;

    private FoxMixinLogger(final @NotNull String id) {
        super(id);
