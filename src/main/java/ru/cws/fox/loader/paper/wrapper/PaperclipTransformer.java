...
public class PaperclipTransformer implements TransformerService {
    ...
    public @Nullable ClassNode transform(@NotNull FoxTransformer transformer, @NotNull Type type, @NotNull ClassNode node, @NotNull TransformPhase phase) throws Throwable {
        ...
        transformer.removeTransformer(PaperclipTransformer.class);
        {
            ...
            methodVisitor.visitTypeInsn(CHECKCAST, "ru/cws/fox/loader/clazz/FoxClassLoader");
            ...
            methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "ru/cws/fox/loader/clazz/FoxClassLoader", "addTransformationPath", "(Ljava/net/URL;)V", false);
            ...
            methodVisitor.visitInvokeDynamicInsn("run", "(Ljava/lang/String;Lru/cws/fox/loader/clazz/FoxClassLoader;[Ljava/lang/String;)Ljava/lang/Runnable;", new Handle(H_INVOKESTATIC, "java/lang/invoke/LambdaMetafactory", "metafactory", "(Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/String;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodHandle;Ljava/lang/invoke/MethodType;)Ljava/lang/invoke/CallSite;", false), Type.getType("()V"), new Handle(H_INVOKESTATIC, "io/papermc/paperclip/Paperclip", "lambda$main$0", "(Ljava/lang/String;Lru/cws/fox/loader/clazz/FoxClassLoader;[Ljava/lang/String;)V", false), Type.getType("()V"));
        ...
        }
        {
            ...
            methodVisitor.desc = "(Ljava/lang/String;Lru/cws/fox/loader/clazz/FoxClassLoader;[Ljava/lang/String;)V";
        }
        {
            ...
            for (int i = 0; i < methodVisitor.instructions.size(); i++) {
                ...
                if (abstractInsnNode instanceof MethodInsnNode methodInsnNode) {
                    if (methodInsnNode.name.equals("exit") && methodInsnNode.owner.equals("java/lang/System")) {
                        methodInsnNode.owner = "ru/cws/fox/loader/paper/wrapper/PaperclipWrapper";
